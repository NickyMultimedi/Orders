...
import be.multimedi.orders.products.productExceptions.NegativeStockAdjustment;
import be.multimedi.orders.products.productExceptions.OutOfStockException;

public class Saw implements Product {
    private int id;
    private String name;
    private int stock;
